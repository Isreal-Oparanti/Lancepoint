...
const SignUp = () => {
  ...
  return (
    <>
      <div id="container" className="flex flex-col lg:flex-row justify-center w-full max-h-screen">
        {/* Left Side - Form */}
            ...
            <form onSubmit={handleFormSubmit} className="flex flex-col justify-center space-y-4 w-full">
              ...
              <div className="flex justify-center">
                ...
                <button
                  ...
                  className="flex justify-center bg-white py-2 px-4 w-full text-xs rounded-full hover:bg-gray-200 transition"
                >
                <img src={Icon} alt="Home Icon" width="20" height="20" /> <span>Solflare</span> 
